<template>
  <el-row>
    ...
    <!-- 细节展示区 -->
    <el-col :span="16" class="detail-card"> 222 </el-col>
  </el-row>
</template>
...
const statLine = computed(() => {
  return (
    ...
    tests.value.length +
    ', wait: ' +
    statusCount.value.WAIT +
    ', pass: ' +
    statusCount.value.PASS +
    ', skip: ' +
    statusCount.value.SKIP +
    ', fail: ' +
    statusCount.value.FAIL +
    ', net_err: ' +
    statusCount.value.NET_ERR
  )
})
